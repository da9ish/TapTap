...
public class Hard extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        v = inflater.inflate(R.layout.fragment_hard, container, false);
    ...
    private void initButton() {
        ...
        btn[25] = (Button) v.findViewById(R.id.btn26);
        btn[26] = (Button) v.findViewById(R.id.btn27);
        btn[27] = (Button) v.findViewById(R.id.btn28);
        btn[28] = (Button) v.findViewById(R.id.btn29);
        btn[29] = (Button) v.findViewById(R.id.btn30);
        btn[30] = (Button) v.findViewById(R.id.btn31);
        btn[31] = (Button) v.findViewById(R.id.btn32);
        btn[32] = (Button) v.findViewById(R.id.btn33);
        btn[33] = (Button) v.findViewById(R.id.btn34);
        btn[34] = (Button) v.findViewById(R.id.btn35);
        btn[35] = (Button) v.findViewById(R.id.btn36);
        btn[36] = (Button) v.findViewById(R.id.btn37);
        btn[37] = (Button) v.findViewById(R.id.btn38);
        btn[38] = (Button) v.findViewById(R.id.btn39);
        btn[39] = (Button) v.findViewById(R.id.btn40);
        btn[40] = (Button) v.findViewById(R.id.btn41);
        btn[41] = (Button) v.findViewById(R.id.btn42);
        btn[42] = (Button) v.findViewById(R.id.btn43);
        btn[43] = (Button) v.findViewById(R.id.btn44);
        btn[44] = (Button) v.findViewById(R.id.btn45);
        btn[45] = (Button) v.findViewById(R.id.btn46);
        btn[46] = (Button) v.findViewById(R.id.btn47);
        btn[47] = (Button) v.findViewById(R.id.btn48);
        btn[48] = (Button) v.findViewById(R.id.btn49);
